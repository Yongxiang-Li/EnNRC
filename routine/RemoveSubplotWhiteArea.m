...
function [] = RemoveSubplotWhiteArea(gca, sub_row, sub_col, current_row, current_col, title_h)
% 设置OuterPosition
sub_axes_x = current_col*1/sub_col - 1/sub_col;
sub_axes_y = 1-current_row*1/sub_row + title_h * 1/sub_row; % y是从上往下的
sub_axes_w = 1/sub_col ; %* (1-0.02);
sub_axes_h = 1/sub_row - (title_h + 0.02) * 1/sub_row;
